...
FilePath: /Cyber-Security-ML-Toolbox/eta/classifiers/anomaly_detection/KitNET/train.py
'''
...
feat_file_path='eta/datasets/data/Kitsune/train_ben.npy'
feat_test_file_path='eta/datasets/data/Kitsune/test.npy'
maxAE=10
